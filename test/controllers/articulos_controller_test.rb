...
class ArticulosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create articulo" do
    assert_difference("Articulo.count") do
      post articulos_url, params: { articulo: { marca_id: @articulo.marca_id, name: @articulo.name, subcategory_id: @articulo.subcategory_id } }
    end
  ...
  test "should update articulo" do
    patch articulo_url(@articulo), params: { articulo: { marca_id: @articulo.marca_id, name: @articulo.name, subcategory_id: @articulo.subcategory_id } }
